    ...
    <div>
        <article class="container">
            <header>
                ...
                <p>Última actualización: 19 de febrero de 2025</p>
            </header>

            <p>Este sitio está protegido por reCAPTCHA y se aplican la <a href="https://policies.google.com/privacy?hl=es" target="_blank" rel="noreferrer">Política de Privacidad</a> y los <a href="https://policies.google.com/terms?hl=es" target="_blank" rel="noreferrer">Términos de Servicio</a> de Google.</p>
            <section>
            ...
            <section>
                ...
                <section>
                    ...
                    <dl>
                        <dt>Compañía</dt>
                        <dd>(denominada "la Compañía", "Nosotros", "Nos" o "Nuestro" en este Acuerdo) se refiere a Arastur Deporte Y Medicina 2018 Sociedad Limitada, Avda. Plaza Diagonal, 14, Nave 40. 50197- Zaragoza.</dd>

                        <dt>Cookies</dt>
                        <dd>son pequeños archivos que un sitio web coloca en su computadora, dispositivo móvil o cualquier otro dispositivo y que contienen los detalles de su historial de navegación en ese sitio web, entre sus muchos usos.</dd>

                        <dt>País</dt>
                        <dd>se refiere a: España</dd>

                        <dt>Dispositivo</dt>
                        <dd>significa cualquier dispositivo que pueda acceder al Servicio, como una computadora, un teléfono celular o una tableta digital.</dd>

                        <dt>Datos Personales</dt>
                        <dd>son cualquier información relacionada con una persona física identificada o identificable.</dd>

                        <dt>El término servicio</dt>
                        <dd>se refiere al sitio web.</dd>

                        <dt>Proveedor de servicios</dt>
                        <dd>significa cualquier persona física o jurídica que procesa los datos en nombre de la Compañía. Se refiere a empresas o individuos de terceros empleados por la Compañía para facilitar el Servicio, para proporcionar el Servicio en nombre de la Compañía, para realizar servicios relacionados con el Servicio o para ayudar a la Compañía a analizar cómo se utiliza el Servicio.</dd>

                        <dt>Los datos de uso</dt>
                        <dd>se refieren a los datos recopilados automáticamente, ya sea generados por el uso del Servicio o por la propia infraestructura del Servicio (por ejemplo, la duración de la visita a una página).</dd>

                        <dt>El sitio web</dt>
                        <dd>se refiere a Crossfit Arastur, accesible desde <a href="https://www.crossfitarastur.com/" rel="external nofollow noopener" target="_blank">https://www.crossfitarastur.com/</a></dd>

                        <dt>Usted</dt>
                        <dd>significa el individuo que accede o utiliza el Servicio, o la empresa u otra entidad legal en nombre de la cual dicho individuo accede o utiliza el Servicio, según corresponda.</dd>
                    </dl>
                </section>
            </section>
            ...
            <section>
                ...
                <section>
                    ...
                    <section>
                        ...
                        <p>Al utilizar nuestro Servicio, podemos solicitarle que nos proporcione cierta información de identificación personal que se puede utilizar para contactarlo o identificarlo. La información de identificación personal puede incluir, entre otras cosas:</p>
                        <ul>
                ...
                <section>
                    ...
                    <ul>
                        <li><strong>Cookies o Cookies del Navegador.</strong> Una cookie es un pequeño archivo que se coloca en Su Dispositivo. Usted puede indicarle a Su navegador que rechace todas las Cookies o que le indique cuándo se envía una Cookie. Sin embargo, si no acepta las Cookies, es posible que no pueda utilizar algunas partes de nuestro Servicio. A menos que haya ajustado la configuración de Su navegador para que rechace las Cookies, nuestro Servicio puede utilizar Cookies.</li>
                        ...
                        <li><strong>Cookies de terceros:</strong> Esta web https://crossfitarastur.com puede utilizar servicios de terceros que, por cuenta de Google, recopilarán información con fines estadísticos, de uso del sitio por parte del usuario y para la prestación de otros servicios relacionados con la actividad del sitio web y otros servicios de Internet. En particular, este sitio web utiliza Google Analytics, un servicio analítico de web prestado por Google, Inc. con domicilio en los Estados Unidos con sede central en 1600 Amphitheatre Parkway, Mountain View, California 94043. Para la prestación de estos servicios, Google utiliza cookies que recopilan la información, incluida la dirección IP del usuario, que será transmitida, tratada y almacenada por Google en los términos fijados en la web Google.com. Esto incluye la posible transmisión de dicha información a terceros por razones de exigencia legal o cuando dichos terceros procesen la información por cuenta de Google.</li>
                    </ul>
                    <p>Las cookies pueden ser "persistentes" o "de sesión". Las cookies persistentes permanecen en su computadora personal o dispositivo móvil cuando se desconecta, mientras que las cookies de sesión se eliminan tan pronto como cierra su navegador web. Obtenga más información sobre las cookies en el artículo <a href="https://www.privacypolicies.com/es/blog/plantilla-politica-privacidad/#Uso_De_Cookies_Registros_De_Archivo_Y_Seguimiento" target="_blank">del sitio web Políticas de privacidad.</a></p>
                    <p>Utilizamos cookies de sesión y persistentes para los fines que se detallan a continuación:</p>
                    <ul>
                        <!--  <li><strong>Cookies necesarias/esenciales</strong> Tipo: Cookies de sesión Administrado por: Nosotros Finalidad: Estas cookies son esenciales para proporcionarle los servicios disponibles a través del sitio web y permitirle utilizar algunas de sus funciones. Ayudan a autenticar a los usuarios y a evitar el uso fraudulento de las cuentas de usuario. Sin estas cookies, no se pueden proporcionar los servicios que ha solicitado y solo utilizamos estas cookies para proporcionarle dichos servicios.</li> -->
                        <li><strong>Política de Cookies / Aviso de Aceptación de Cookies</strong> Tipo: Cookies persistentes Administrado por: Nosotros Finalidad: Estas Cookies identifican si los usuarios han aceptado el uso de cookies en el Sitio Web.</li>
                        <li><strong>Cookies de funcionalidad</strong> Tipo: Cookies persistentes Administrado por: Nosotros Finalidad: Estas cookies nos permiten recordar las opciones que usted elige cuando utiliza el sitio web, como por ejemplo sus datos de acceso o su preferencia de idioma. La finalidad de estas cookies es proporcionarle una experiencia más personalizada y evitar que tenga que volver a introducir sus preferencias cada vez que utilice el sitio web.</li>
                    </ul>
            ...
            <section>
                ...
                <p>En cualquier momento, puedes adaptar la configuración del navegador para gestionar, desestimar el uso de cookies y ser notificado antes de que se descarguen. También puedes adaptar la configuración de forma que el navegador rechace todas las cookies, o únicamente las cookies de terceros. Y también puedes eliminar cualquiera de las cookies que ya se encuentren en tu equipo. Para esto, debes tener en cuenta que tendrás que adaptar por separado la configuración de cada navegador y equipo que utilices ya que, como te hemos comentado anteriormente las cookies se asocian al navegador, no a la persona.</p>
                <ul class="wp-block-list">
                    <li>Google Chrome <a href="https://support.google.com/chrome/answer/95647?hl=es-419" target="_blank">https://support.google.com/chrome/answer/95647?hl=es-419</a></li>
                    ...
                    <li>Apple Safari <a href="https://support.apple.com/es-es/HT201265" target="_blank">https://support.apple.com/es-es/HT201265</a></li>
                </ul>
                <p>Si tienes cualquier duda sobre esta Política de Cookies, puedes contactar con nosotros enviándonos un mail a <a href="mailto:crossfitarastur@gmail.com">crossfitarastur@gmail.com</a></p>
            </section>

            <section>
                <h3>Uso de sus datos personales</h3>
                <p>La Compañía podrá utilizar los Datos Personales para los siguientes fines:</p>
                <ul>
                    <li><strong>Para proporcionar y mantener nuestro Servicio</strong>, incluido el seguimiento del uso del mismo.</li>
                    <li><strong>Para gestionar su cuenta:</strong> para gestionar su registro como usuario del Servicio. Los Datos Personales que proporcione pueden darle acceso a diferentes funcionalidades del Servicio que están disponibles para usted como usuario registrado.</li>
                    <li><strong>Para la ejecución de un contrato:</strong> el desarrollo, cumplimiento y ejecución del contrato de compra de los productos, artículos o servicios que Usted ha adquirido o de cualquier otro contrato con Nosotros a través del Servicio.</li>
                    <li><strong>Para comunicarnos con Usted:</strong> Para comunicarnos con Usted por correo electrónico, llamadas telefónicas, SMS u otras formas equivalentes de comunicación electrónica, como las notificaciones push de una aplicación móvil sobre actualizaciones o comunicaciones informativas relacionadas con las funcionalidades, productos o servicios contratados, incluidas las actualizaciones de seguridad, cuando sea necesario o razonable para su implementación.</li>
                    <li><strong>Para brindarle</strong> noticias, ofertas especiales e información general sobre otros bienes, servicios y eventos que ofrecemos y que sean similares a los que ya ha comprado o consultado, a menos que haya optado por no recibir dicha información.</li>
                    <li><strong>Para gestionar sus solicitudes:</strong> Para atender y gestionar las solicitudes que nos envíe.</li>
                ...
                <ul>
                    <li><strong>Con proveedores de servicios:</strong> Podemos compartir su información personal con proveedores de servicios para monitorear y analizar el uso de nuestro Servicio y para comunicarnos con usted.</li>
                    <li><strong>Para transferencias comerciales:</strong> Podemos compartir o transferir su información personal en relación con, o durante las negociaciones de, cualquier fusión, venta de activos de la empresa, financiamiento o adquisición de la totalidad o parte de nuestro negocio a otra empresa.</li>
                    ...
                    <li><strong>Con otros usuarios:</strong> cuando Usted comparte información personal o interactúa de otra manera en áreas públicas con otros usuarios, dicha información puede ser vista por todos los usuarios y puede distribuirse públicamente en el exterior.</li>
            ...
            <section>
                ...
                <p>Su información, incluidos los Datos Personales, se procesa en las oficinas operativas de la Compañía y en cualquier otro lugar donde se encuentren las partes involucradas en el procesamiento. Esto significa que esta información puede transferirse a computadoras ubicadas fuera de su estado, provincia, país u otra jurisdicción gubernamental donde las leyes de protección de datos pueden diferir de las de su jurisdicción y mantenerse en ellas.</p>
                <p>Su consentimiento a esta Política de privacidad seguido de su envío de dicha información representa su aceptación de dicha transferencia.</p>
            ...
            <section>
                ...
                <section>
                    ...
                    <p>Si la Compañía participa en una fusión, adquisición o venta de activos, sus Datos Personales pueden ser transferidos. Le notificaremos antes de que sus Datos Personales sean transferidos y queden sujetos a una Política de Privacidad diferente.</p>
                </section>
                ...
                <section>
                    ...
                    <p>La Compañía podrá divulgar sus Datos Personales creyendo de buena fe que dicha acción es necesaria para:</p>
                    <ul>
            ...
            <section>
                ...
                <p>Si necesitamos confiar en el consentimiento como base legal para procesar su información y su país requiere el consentimiento de uno de sus padres, es posible que solicitemos el consentimiento de sus padres antes de recopilar y utilizar esa información.</p>
            </section>
            ...
            <section>
                ...
                <p>Se recomienda revisar periódicamente esta Política de privacidad para comprobar si se han producido cambios. Los cambios a esta Política de privacidad entran en vigor cuando se publican en esta página.</p>
            </section>
            ...
            <footer>
                ...
                <ul>
                    <li>Por correo electrónico: <a href="mailto:crossfitarastur@gmail.com">crossfitarastur@gmail.com</a></li>
                    <li>Visitando nuestro sitio web: <a href="https://www.crossfitarastur.com/" rel="external nofollow noopener" target="_blank">https://www.crossfitarastur.com/</a></li>
                    <li>Por teléfono: <a href="tel:628344844">628 34 48 44</a></li>
                </ul>
            </footer>
        </article>
    </div>
